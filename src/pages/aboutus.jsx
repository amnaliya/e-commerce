            ...
            <div className="min-h-screen bg-[#f7f3eb]">
                <section className="px-5 py-16 text-center sm:px-8 sm:py-20">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600 sm:text-lg">
                        YESTERA is a vintage marketplace created for people
                        who believe that beautiful things deserve a second
                        story.
                    </p>
                </section>
                    ...
                    <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2">
                        ...
                        <div className="rounded-xl bg-white p-7 shadow-sm sm:p-10">
                            ...
                            <p className="mt-5 leading-7 text-gray-600">
                                We started YESTERA with a simple idea —
                                the past should never feel forgotten.
                            </p>

                            <p className="mt-4 leading-7 text-gray-600">
                                From vintage cameras and vinyl records to
                                timeless posters and unique collectibles,
                                every piece carries a little bit of history.
                                We bring these pieces together so they can
                                find a new home and become part of someone
                                else's story.
                            </p>
                        </div>
                        ...
                        <div className="mt-10 grid gap-5 sm:grid-cols-3">
                            ...
                            <div className="rounded-xl bg-[#f7f3eb] p-7">
                                ...
                                <p className="mt-3 text-sm leading-6 text-gray-600">
                                    We celebrate objects that continue to
                                    hold their charm through generations.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-[#f7f3eb] p-7">
                                ...
                                <p className="mt-3 text-sm leading-6 text-gray-600">
                                    Giving vintage pieces a new home means
                                    giving old treasures a new life.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-[#f7f3eb] p-7">
                                ...
                                <p className="mt-3 text-sm leading-6 text-gray-600">
                                    Every piece has a story, and we want you
                ...
                <section className="px-5 py-16 text-center sm:px-8 sm:py-20">
                    ...
                    <div className="mx-auto max-w-3xl">
                        ...
                        <p className="mt-5 text-base leading-7 text-gray-600 sm:text-lg sm:leading-8">
                            At YESTERA, our mission is to make vintage
                            accessible, beautiful, and meaningful. We want
                            every customer to discover something that feels
