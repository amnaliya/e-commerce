  ...
  return (
    <>
      <div className="min-h-screen bg-[#f7f3eb] px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
        <h1 className="font-bold p-6  text-3xl sm:mb-10 sm:text-4xl font-serif text-[#4A2C22] sm:p-10 shadow-lg mb-10 text-center">
          My Orders
        </h1>
        {orders.length === 0 ? (
          ...
          <div className="mx-auto max-w-5xl space-y-6">
            {orders.map((value) => (
              <div className="rounded-xl bg-white p-6 shadow-sm" key={value.id}>
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    <h2 className="font-serif text-xl font-bold text-[#4A2C22]">
                      Order <br />
                      Id#{value.id}{" "}
                    </h2>
                  ...
                  {value.items.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h3 className="font-serif text-lg font-semibold text-[#4A2C22]">
                          {item.name}
                        </h3>
