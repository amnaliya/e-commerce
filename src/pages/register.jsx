    ...
    <>
      <div className="flex justify-center bg-[#f7f3eb]   min-h-screen px-7">
        <div className="w-full max-w-md rounded-lg bg-white p-8 m-5 shadow-sm">
          <h1 className="text-center font-serif text-4xl text-[#4A2C22]">
            CREATE ACCOUNT
          </h1>
          <p className="text-sm text-center mt-5 text-stone-500">
            Join YESTERRA and Discover Timeless Treasures{" "}
          </p>
          ...
          <div className="mt-5 space-y-3">
            <form onSubmit={handleregister}>
              ...
              <button className="w-full bg-[#1F4D3A] py-3 text-white mt-7">
                Create Account
              </button>
            </form>
            ...
            <div className="mt-6 border-t border-stone-200 pt-6">
              <div className="rounded-lg bg-[#f7f3eb] p-5 text-center">
                ...
                <button
                  className=" mt-3 w-full bg-[#1F4D3A] py-3 text-white"
