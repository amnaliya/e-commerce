              ...
              >
                ...
                >
                  <div className="relative">
                    ...
                    >
                      <Heart
                        size={22}
                        className={
                          wishlist.some((item) => item.productId === value.id)
                  ...
                  <div className="sm:p-5 p-3">
                    <h2 className="sm:font-lg line-clamp-2 text-sm font-serif text-[#4A2C22]  ">
                      {value.name}
                    </h2>
                    <p className="font-semibold text-[#1F4D3A] sm:text-base sm:mt-2">
                      ₹{value.price}
                    </p>
                  </div>
                </Link>
                ...
                <div className="px-3 pb-3 sm:px-5 sm:pb-5">
                  <button
                    ...
                    className="bg-[#1F4D3A] rounded-md  mt-2 sm:mt-4 w-full text-white font-medium px-2 py-2 text-xs sm:text-lg"
                  >
                    Add To Cart
                  </button>
                </div>
