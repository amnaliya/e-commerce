          ...
          <div>
            {wishlist.length === 0 ? (
              <div className="rounded-xl bg-white p-8 text-center shadow-sm sm:p-10">
                <p className=" text-xl sm:text-5xl text-gray-800">
                ...
                {wishlist.map((value) => (
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5">
                      <h2 className="text-[#4A2C22] font-serif text-2xl  line-clamp-2 sm:text-2xl font-bold">
                        {value.name}
                      </h2>
                      <p className="mt-2  text-[#1F4D3A] font-semibold text-lg">
                        {value.price}
                      </p>
                      <button
                        className="mt-4 w-full rounded-md bg-red-500 px-3 py-2 font-medium text-white sm:px-4 sm:py-3 sm:text-base"
